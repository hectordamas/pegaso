			...
			for ($i = 0; $i < count($data['serial']); $i++) {
				...
				if ($data['evento'][$i] == 'D') {
					...
					if (empty($pgConsulSQL)) {
						...
						$pgConsulSQL->serial = $data['serial'][$i];
						$pgConsulSQL->TipoFac = $data['TipoFac'][$i];
						$pgConsulSQL->NumeroD = $data['NumeroD'][$i];
						$pgConsulSQL->OTipo = $data['OTipo'][$i];
						$pgConsulSQL->ONumero = $data['ONumero'][$i];
						$pgConsulSQL->Status = $data['Status'][$i];
						$pgConsulSQL->NroLinea = $data['NroLinea'][$i];
						$pgConsulSQL->NroLineaC = $data['NroLineaC'][$i];
						$pgConsulSQL->CodItem = $data['CodItem'][$i];
						$pgConsulSQL->CodUbic = $data['CodUbic'][$i];
						$pgConsulSQL->CodMeca = $data['CodMeca'][$i];
						$pgConsulSQL->CodVend = $data['CodVend'][$i];
						$pgConsulSQL->Descrip1 = $data['Descrip1'][$i];
						$pgConsulSQL->Descrip2 = $data['Descrip2'][$i];
						$pgConsulSQL->Descrip3 = $data['Descrip3'][$i];
						$pgConsulSQL->Descrip4 = $data['Descrip4'][$i];
						$pgConsulSQL->Descrip5 = $data['Descrip5'][$i];
						$pgConsulSQL->Descrip6 = $data['Descrip6'][$i];
						$pgConsulSQL->Descrip7 = $data['Descrip7'][$i];
						$pgConsulSQL->Descrip8 = $data['Descrip8'][$i];
						$pgConsulSQL->Descrip9 = $data['Descrip9'][$i];
						$pgConsulSQL->Descrip10 = $data['Descrip10'][$i];
						$pgConsulSQL->Refere = $data['Refere'][$i];
						$pgConsulSQL->Signo = $data['Signo'][$i];
						$pgConsulSQL->CantMayor = $data['CantMayor'][$i];
						$pgConsulSQL->Cantidad = $data['Cantidad'][$i];
						$pgConsulSQL->CantidadO = $data['CantidadO'][$i];
						$pgConsulSQL->Tara = $data['Tara'][$i];
						$pgConsulSQL->ExistAntU = $data['ExistAntU'][$i];
						$pgConsulSQL->ExistAnt = $data['ExistAnt'][$i];
						$pgConsulSQL->CantidadU = $data['CantidadU'][$i];
						$pgConsulSQL->CantidadC = $data['CantidadC'][$i];
						$pgConsulSQL->CantidadA = $data['CantidadA'][$i];
						$pgConsulSQL->CantidadUA = $data['CantidadUA'][$i];
						$pgConsulSQL->TotalItem = $data['TotalItem'][$i];
						$pgConsulSQL->Costo = $data['Costo'][$i];
						$pgConsulSQL->Precio = $data['Precio'][$i];
						$pgConsulSQL->Descto = $data['Descto'][$i];
						$pgConsulSQL->NroUnicoL = $data['NroUnicoL'][$i];
						$pgConsulSQL->NroLote = $data['NroLote'][$i];
						$pgConsulSQL->FechaE = $data['FechaE'][$i]; // $data['FechaE'][$i];

						$pgConsulSQL->EsServ = $data['EsServ'][$i];
						$pgConsulSQL->EsUnid = $data['EsUnid'][$i];
						$pgConsulSQL->EsFreeP = $data['EsFreeP'][$i];
						$pgConsulSQL->EsPesa = $data['EsPesa'][$i];
						$pgConsulSQL->EsExento = $data['EsExento'][$i];
						$pgConsulSQL->UsaServ = $data['UsaServ'][$i];
						$pgConsulSQL->DEsLote = $data['DEsLote'][$i];
						$pgConsulSQL->DEsSeri = $data['DEsSeri'][$i];
						$pgConsulSQL->DEsComp = $data['DEsComp'][$i];
						$pgConsulSQL->NumeroE = $data['NumeroE'][$i];
						$pgConsulSQL->CodSucu = $data['CodSucu'][$i];
						$pgConsulSQL->MtoTax = $data['MtoTax'][$i];
						$pgConsulSQL->TipoPVP = $data['TipoPVP'][$i];
						$pgConsulSQL->save();
					}
				}
			}
