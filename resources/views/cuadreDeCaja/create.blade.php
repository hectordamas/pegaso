...
@section('metadata')
<title>Registrar Cuadre de Caja - {{ env('APP_NAME') }}</title>
@endsection
...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="{{ route('cuadre-de-caja.store') }}" method="POST">
            @csrf

            <div class="card mb-4">
                <div class="card-header">
                    <h5>📠 Registrar Cuadre de Caja</h5>
                </div>
                <div class="card-block row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <textarea name="observaciones" rows="1" class="form-control"></textarea>
                    </div>
