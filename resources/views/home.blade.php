...
@section('content')
    <div class="row">
        ...
        <div class="col-xl-6 col-md-12 form-group text-right">
            <div class="btn-group">
                <button onclick="getHomeData('anio', this)" type="button" class="btn btn-inverse btn-round btn-filter">
                    <i class="fas fa-check-circle"></i> Año
                </button>
                <button onclick="getHomeData('mes', this)" type="button" class="btn btn-outline-success btn-round btn-filter">
                    <i class="fas fa-check-circle"></i> Mes
                </button>
                <button onclick="getHomeData('dia', this)" type="button" class="btn btn-outline-success btn-round btn-filter">
                    ...
                    <div class="card-block">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h4 class="m-b-0" id="saldoPorCobrar">${{ number_format(0, 2, ',', '.') }}</h4>
                            </div>
                            ...
                            <div class="card-block">
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <h4 class="m-b-0" id="entregasEntregado">0 / 0</h4>
                                    </div>
                                    <div class="col col-auto text-end">
                            ...
                            <div class="card-block">
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <h4 class="m-b-0" id="entregasEnProceso">0</h4>
                                    </div>
                                    <div class="col col-auto text-end">
                            ...
                            <div class="card-block">
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <h4 class="m-b-0" id="clientesAtendidos">0</h4>
                                    </div>
                                    <div class="col col-auto text-end">
                ...
                <div class="col-lg-3">
                    <div class="card shadow" style="height: 95%">
                        ...
                        <div class="card-block">
                            ...
                            <div id="cxcLabels" class="mt-4 text-center small">
                                <!-- Los labels se llenarán con jQuery -->
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function getHomeData(type, btn = null){
            ...
            if (btn) {
                ...
                document.querySelectorAll('.btn-filter').forEach(b => {
                    b.classList.remove('btn-inverse');
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    const labels = res.saldosPorCliente.map(c => c.cliente);
                    // Etiquetas
                    $('#cxcLabels').empty();
                    $.each(labels, function(i, label) {
                        $('#cxcLabels').append(`
                            <span class="d-block mb-2" style="margin-right: 15px;">
                                <i class="fas fa-circle" style="color: ${cxcColors[i]};"></i> ${label}
                            </span>
                        `);
                    });
                    ...
                    if($('#entradaEquipos').length){
                        ...
                        new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    label: 'Cantidad',
                                    data: res.entradaEquiposCantidad,  
                        ...
                        new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [
                                    {
                                        label: 'Ventas',
                                        data: res.ventasVendedorTotales,
                                    ...
                                    {
                                        label: 'Cobrado',
                                        data: res.cobrosVendedorTotales,
