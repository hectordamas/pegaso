...
@section('content')
    ...
    <div class="modal fade SoporteModalView" tabindex="-1" id="SoporteModalView" aria-labelledby="SoporteModalViewLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="SoporteModalViewLabel">Detalles del Servicio #<span
                            class="SoporteId"></span></h6>
...
@section('scripts')
    <script>
        ...
        window.soporteDetalles = function(soporteId) {
            ...
            $.ajax({
                url: '{{ url('soporte/ver-detalles') }}' + '/' +
                    soporteId, // Asegúrate de que esta ruta sea correcta
                method: 'POST',
                data: {
